...
const { updateNotice, testCompany, initiaNotice } = require('./data/notice');
...
describe('UPDATE_NOTICE', () => {
  ...
  test('FAIL: INVALID_INPUT ERROR', async () => {
    await request(app)
      .put('/notice/c2c61451-4de9-4b54-bdbd-9f16266dd39c')
      .send()
  ...
  test('FAIL: INVALID_UUID ERROR', async () => {
    await request(app)
      .put('/notice/c2c61451-4de9-4b54-bdbd-9f16266dd')
      .send(updateNotice)
      .expect({ message: 'INVALID_INPUT', code: 'NOT_FOUND' })
      .expect(404);
  });
  ...
  test('FAIL: INVALID_NOTICEID ERROR', async () => {
    await request(app)
      .put('/notice/c2c61451-4de9-4b54-bdbd-9f16266dd391')
      .send(updateNotice)
      .expect({ message: 'INVALID_NOTICEID', code: 'NOT_FOUND' })
      .expect(404);
  });

  test('SUCCESS: Updated Notice', async () => {
    await request(app)
      .put('/notice/c2c61451-4de9-4b54-bdbd-9f16266dd39c')
      .send(updateNotice)
      .expect({ message: 'COMPLETE_UPDATE' })
      .expect(201);
  });
});
